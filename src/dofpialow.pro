;+
; DOFPIALOW - First attempt to make automatic IA on LBC science chips
...
; SPECIAL VERSION TO USE CHIP 2 BELOW ROTATOR CENTER
...
; Main Program
Pro DoFPIAlow, Sim=Sim, X2=X2, RedOnly=RedOnly, BlueOnly=BlueOnly, $
