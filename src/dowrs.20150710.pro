...
; make dofpia_wrs all lower case JMH 20150708
; KS  -  09-JUL-2015
...
If Not KeyWord_Set(Sim) Then Begin
  If (DoBlue EQ 0) AND (DoRed GE 1) Then Begin
      Print, "Loading OB ", HomeDir+"/src/load-ob40-red.pl"
      Spawn, HomeDir+"/src/load-ob40-red.pl", Result, ErrResult
  EndIf  
  If (DoBlue GE 1) AND (DoRed EQ 0) Then Begin
      Print, "Loading OB ", HomeDir+"/src/load-ob40-blue.pl"
      Spawn, HomeDir+"/src/load-ob40-blue.pl", Result, ErrResult
  EndIf
  If (DoBlue GE 1) AND (DoRed GE 1) Then Begin
      Print, "Loading OB ", HomeDir+"/src/load-ob40.pl"
      Spawn, HomeDir+"/src/load-ob40.pl", Result, ErrResult
  EndIf
