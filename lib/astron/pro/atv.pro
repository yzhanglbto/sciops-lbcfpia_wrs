...
state = {                   $
        ...
        mousemode: "imexam", $   ; color, blink, zoom, or imexam
        ...
        photzpt: 21.4, $        ; magnitude zeropoint
        ...
        ccdgain: 1.3, $         ; CCD gain
        ccdrn: 10.0, $           ; read noise
        centerboxsize: 13L, $    ; centering box size
        aprad: 15.0, $           ; aperture photometry radius
        innersky: 20.0, $       ; inner sky radius
        outersky: 25.0, $       ; outer sky radius
        ...
        statboxsize: 15L, $     ; box size for computing statistics
